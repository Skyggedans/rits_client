...
class _KpiScreenState extends ViewObjectScreenState<KpiBloc, KpiGenerated> {
  ...
  @override
  Widget buildOutputWidget(KpiGenerated state) {
    ...
    if (kpis.length > 0) {
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final userText1 = kpi.userText1 != null
              ? '\n${kpi.userText1}: ${kpi.extraData1}'
              : null;

          final userText2 = kpi.userText2 != null
              ? '\n${kpi.userText2}: ${kpi.extraData2}'
              : null;
